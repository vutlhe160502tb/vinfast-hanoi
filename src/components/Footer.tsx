...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#f5f4f0", borderTop: "1px solid #e8e8e8" }}>
      {/* Main grid */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <Image
              ...
              width={180}
              height={50}
              className="h-10 w-auto object-contain mb-5 brightness-0"
            />
            <h3 className="text-gray-900 font-bold text-base mb-4 tracking-wide">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:0976633054" className="text-[#db2a2a] font-bold text-sm hover:text-red-700 transition-colors">
                  097.6633.054
                </a>
              </div>
            </div>

            <div className="mt-6 relative h-20 rounded-xl overflow-hidden border border-gray-200">
              <Image
          ...
          {/* Col 2 — Products */}
          <div>
            <h3 className="text-gray-900 font-bold text-sm uppercase tracking-[0.15em] mb-5 pb-3 border-b border-gray-200">
              SẢN PHẨM
            </h3>
            <div className="space-y-2.5 mb-5">
              {allCars.map((car) => (
                ...
                >
                  <span className="text-gray-500 text-sm group-hover:text-gray-900 transition-colors duration-200">
                    {car.name}
                  </span>
                  <span className="text-gray-400 text-xs group-hover:text-[#db2a2a] transition-colors duration-200">
